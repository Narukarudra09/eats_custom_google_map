...
final List<Marker> getEateries = [
  ...
  Marker(
    ...
    infoWindow:
        const InfoWindow(title: 'Way 2 Coffee', snippet: 'General Eatery'),
    icon: AssetMapBitmap("assets/images/cafe's_marker_image/coffee.png",
        height: 45, width: 45),
  ),
  ...
  Marker(
    ...
    infoWindow:
        const InfoWindow(title: 'Nivi\'s Cafe', snippet: 'General Eatery'),
    icon: AssetMapBitmap("assets/images/cafe's_marker_image/coffee.png",
        height: 45, width: 45),
  ),
...
final List<Marker> getBasicEateries = [
  ...
  Marker(
    ...
    position: const LatLng(25.33704520072666, 74.64295895344343),
    infoWindow:
  ...
  Marker(
    ...
    infoWindow:
        const InfoWindow(title: 'Green plaza', snippet: 'General Eatery'),
    icon: AssetMapBitmap(
        "assets/images/restaurant's_marker_image/restaurant.png",
        height: 45,
        width: 45),
  ...
  Marker(
    ...
    infoWindow: const InfoWindow(
        title: 'Coco Bhilwara Cafe', snippet: 'Detailed Eatery'),
    icon: AssetMapBitmap("assets/images/cafe's_marker_image/coffee.png",
        height: 45, width: 45),
  ),
  Marker(
...
final List<Marker> getDetailedEateries = [const Marker(
  ...
  Marker(
    ...
    infoWindow: const InfoWindow(
        title: 'Season 6 pure veg Restaurant', snippet: 'General Eatery'),
    icon: AssetMapBitmap(
        "assets/images/restaurant's_marker_image/restaurant.png",
        height: 45,
        width: 45),
  ...
  Marker(
    ...
    position: const LatLng(25.342810982903778, 74.63939976481582),
